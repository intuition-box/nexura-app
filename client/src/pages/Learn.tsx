  ...
  return (
    <div className="min-h-screen bg-black text-white overflow-auto p-4 sm:p-6 relative">
      ...
      <div className="max-w-4xl mx-auto relative z-10 space-y-12">
        ...
        {/* Coming Soon Card */}
        <Card className="glass glass-hover rounded-2xl sm:rounded-3xl p-4 sm:p-8 animate-slide-up delay-400">
          <CardHeader className="text-center pb-4 sm:pb-6">
            <div className="w-10 h-10 sm:w-12 sm:h-12 bg-white/5 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4 animate-slide-up delay-500">
              <Clock className="w-5 h-5 sm:w-6 sm:h-6 text-white/60" />
            </div>
            <CardTitle className="text-lg sm:text-xl font-bold text-white animate-slide-up delay-600">
              No Learning Materials Available
            </CardTitle>
          </CardHeader>
          <CardContent className="text-center space-y-3 sm:space-y-4">
            <p className="text-sm sm:text-base text-white/60 leading-relaxed animate-slide-up delay-700">
            ...
            <div className="text-xs sm:text-sm text-muted-foreground animate-slide-up delay-800">
